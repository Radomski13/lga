export default async function handler(req,res){
  ...
  try{
    ...
    const results = restaurantData.map(r=>{
      ...
      const score = (gasCost/avgPlate) - tastiness*(tastinessWeight/10);

      return { ...r, distance:distance.toFixed(2), gasCost:gasCost.toFixed(2), totalCost:totalCost.toFixed(2), totalScore:score.toFixed(2) };
    });
